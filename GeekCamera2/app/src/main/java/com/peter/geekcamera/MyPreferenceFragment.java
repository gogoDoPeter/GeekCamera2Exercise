...
import com.peter.geekcamera.ui.ArraySeekBarPreference;
...
public class MyPreferenceFragment extends PreferenceFragment implements OnSharedPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final String hardwareLevel = bundle.getString("hardwareLevel");
            ...
            pref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference arg0) {
                    if( pref.getKey().equals("preference_about") ) {
                        ...
                        about_string.append("Geek Camera2 v");
                        ...
                        about_string.append("\nHardware-Level: ");
                        about_string.append(hardwareLevel);
                        about_string.append("\nCapabilities: ");
                        String [] capabilities_values = bundle.getStringArray("supported_capabilities");
                        if( capabilities_values != null && capabilities_values.length > 0 ) {
                            for(int i=0;i<capabilities_values.length;i++) {
                                if( i > 0 ) {
                                    about_string.append(", ");
                                }
                                about_string.append(capabilities_values[i]);
                            }
                        }
                        else {
